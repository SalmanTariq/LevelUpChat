        ...
        <div class="mt-8">
          ...
          <div class="mt-6">
            ...
            <div class="relative border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                <label for="name" value="Name" class="absolute -top-2 left-2 -mt-px inline-block px-1 bg-white text-xs font-medium text-gray-900">Display Name</label>
                <input type="text" name="name" id="name" class="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" v-model="form.name" required autofocus autocomplete="name" />
            </div>
           ...
           <div class="relative border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center" v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                  <input :checked="form.terms" id="terms" name="terms" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"  />
